...
> **DTimpalr — a Date/Time Pattern Language for Repetition.** A pattern *matches* an instant: the language's defining operation is `is(pattern, instant)`, not occurrence generation.
